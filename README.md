...
This project is no longer active (to be honest it wasn't for the last two years) ...

BUT I've started a new project (with the same idea to manage your Udemy Notes outside of Udemy) with a new tech stack. At the moment of this writing you are able to import your Udemy notes from the html you exported on Udemy. You can view the notes inside the app and you can export them as .md file which gives you right now the freedom to work with your notes however you want to.

It is planned that you can edit the notes in the app, that you can add tags to complete courses and individual notes.

The new project is available under [Udemy Notes](https://udemy-notes.vercel.app)

The Github Repository of the new project is available [here](https://github.com/powiedl/udemy-notes)
